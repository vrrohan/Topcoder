...
public class MissingDwarf {
	...
	public static int getHeight(int[] otherHeights) {
		int sumOfAllOtherDrawfHeights = IntStream.of(otherHeights).sum();
		int missingDwarfHeight = IntStream.of(otherHeights).max().getAsInt() + 1;
		while ((sumOfAllOtherDrawfHeights + missingDwarfHeight) % 7 != 0) {
			missingDwarfHeight++;
		}
		return missingDwarfHeight;
	}

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		int[] dwarfs = { 6, 5, 4, 3, 2, 1 };
		int[] dwarfs2 = { 10, 10, 20, 20, 30, 30 };
		int[] dwarfs3 = { 7, 7, 7, 7, 7, 7 };
		System.out.println(getHeight(dwarfs2));
	}
