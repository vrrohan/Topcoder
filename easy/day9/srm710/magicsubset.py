...
def findBest(values) :
    ...
    for i in range(1, len(values)) :
        if values[i]>=0 :
            ...
            negSum += values[i]
    negSum *= -1
    return posSum if(posSum>negSum) else negSum

print(findBest([-3, 1, -4, 1, 5, -9, 2, 6, -5, 3, 5 ]))
print(findBest([12, 6, 46, 20, 22, -40, 41, 29, 27, -22, -33, -6, -30, -11, -50, 35,
