...
Returns: 2
"""
def getMinimumSteps(pos) :
    return 3 if (6 in pos) else 2 if (2 in pos or 5 in pos or 7 in pos) else 1 if (1 in pos or 3 in pos or 4 in pos) else 0

print(getMinimumSteps([7, 7, 1, 6, 4, 1, 7, 6, 6, 6, 2, 3, 2, 7, 4, 5, 2, 4, 6, 1, 7, 2,
				5, 6, 1, 2, 7, 5, 4, 3, 5, 4, 2, 7, 3, 1, 5, 1, 3, 7]))
print(getMinimumSteps([4, 3, 3, 1, 3, 4, 1, 3, 1, 3, 3, 1, 4, 4, 4, 4, 1, 4, 3, 4]))
