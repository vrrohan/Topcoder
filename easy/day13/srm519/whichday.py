...
Returns: "Thursday"
"""
def getDay(notOnThisDay) :
    meetingDay = ''
    weekDays = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']
    for days in weekDays :
        if days not in notOnThisDay :
            meetingDay = days
            break
    return meetingDay

print(getDay(["Saturday", "Friday", "Tuesday", "Sunday", "Thursday", "Monday"]))
print(getDay(["Tuesday", "Sunday", "Friday", "Wednesday", "Thursday", "Saturday"]))
